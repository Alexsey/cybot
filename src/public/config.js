...
const config = {
  ...
  minersTable: {
    ...
    useFakeData: true,
    fakeData: {
      ETH: {deposit: 7.38346486, withdrawal: 0},
      ETC: {deposit: 31.56129412, withdrawal: 0},
      MUSIC: {deposit: 183224.20227025, withdrawal: 0},
      SC:    {deposit: 531088.83826586, withdrawal: 0},
